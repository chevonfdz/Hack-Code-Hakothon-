...
var postIdIndex = getPostArrayIndexById(postId);

document.title = `Healthy Lives | ${postData[postIdIndex]["main-heading"]}`;
document.getElementById("main-heading").innerHTML = postData[postIdIndex]["main-heading"];
document.getElementById("content-image-div").innerHTML = `<img src="images/post-page/${postData[postIdIndex]["content-image-name"]}" alt="Content Image">`;
document.getElementById("content-body-paragraph").innerHTML = postData[postIdIndex]["content-body-paragraph"];
document.getElementById("user-details-name").innerHTML = postData[postIdIndex]["user-details-name"];
document.getElementById("user-details-description").innerHTML = postData[postIdIndex]["user-details-description"];
document.getElementById("user-image-div").innerHTML = `<img src="images/post-page/${postData[postIdIndex]["user-details-image-name"]}" alt="User Image">`;


function getPostArrayIndexById(postId) {
